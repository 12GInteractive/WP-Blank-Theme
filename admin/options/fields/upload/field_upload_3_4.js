...
jQuery(document).ready(function () {
    ...
    jQuery('.rh-opts-upload').click(function () {
        header_clicked = true;
    ...
    jQuery('.rh-opts-upload-remove').click(function () {
        $relid = jQuery(this).attr('rel-id');
        jQuery('#' + $relid).val('');
        jQuery(this).prev().fadeIn('slow');
        jQuery(this).prev().prev().fadeOut('slow', function () { jQuery(this).attr("src", rh_upload.url); });
