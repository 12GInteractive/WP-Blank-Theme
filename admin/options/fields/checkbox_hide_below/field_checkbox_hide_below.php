<?php
class rh_Options_checkbox_hide_below {
    ...
    */
	...
	echo '>';
	echo '<input data-amount="' . $next_to_hide . '" type="checkbox" id="' . $this->field['id'] . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . ']" value="1" class="' . $class . ' rh-opts-checkbox-hide-below" ' . checked($this->value, '1', false) . ' /> ';
    ...
    */
    function enqueue() {
        wp_enqueue_script(
            'rh-opts-checkbox-hide-below-js', 
            rh_OPTIONS_URL . 'fields/checkbox_hide_below/field_checkbox_hide_below.js', 
            array('jquery'),
            time(),
            true
        );
